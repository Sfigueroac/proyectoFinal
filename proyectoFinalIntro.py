...
def actualizar_inventario_pandas(pedido):
    ...
    try:
        ...
        print(f"Inventario antes de la actualización: \n{df_inventario}")  # Imprimir el inventario para depurar
        ...
        print(f"Inventario después de la actualización: \n{df_inventario}")  # Imprimir el inventario después de la actualización
...
def atencion_mesa():
    ...
    try:
        ...
        if mesa["ocupada"]:
            ...
            mesa["pedidos"], mesa["total"] = registrar_pedido("mesa")
            mesa["ocupada"] = True
            print(f"\nPedido registrado para la mesa {mesa_num}.")
    except (ValueError, IndexError):
        print("Número de mesa inválido.")
...
def compra_para_llevar():
    print("\n--- Compra para llevar ---")
    pedido, total = registrar_pedido("llevar")
